const Projects = [
	{
		...
		category: "web",
		label: "UI/UX Design and Development",
		labelRole: "Led UI/UX design contributions and implemented responsive front-end development using HTML, CSS, JS, and SCSS. Successfully integrated Google Analytics 5 (GA5) for advanced tracking and insights. Collaborated closely with the client to gather requirements and ensure seamless execution. This AI-driven interview platform enhances user engagement and evaluation through intelligent automation.",
	...
	},
	{
		...
		category: "react",
		label: "UI Development",
		labelRole: "Developed and enhanced the UI/UX, ensuring a seamless and engaging experience for users. Implemented front-end development using HTML, CSS, JS, and SCSS within a React-based architecture. improved accessibility and performance. Collaborated closely with the client to gather requirements and optimize user interactions. This innovative platform empowers children by fostering self-esteem and confidence through a holistic, technology-driven approach.",
	...
	},
	{
		...
		labelRole: "Led UI development with a strong focus on accessibility, UI/UX, ensuring compliance with WCAG 2.0 standards. Implemented responsive front-end solutions using HTML, CSS, JS, and SCSS within a Sitecore CMS environment. Enhanced user experience through intuitive UI/UX design and seamless navigation. Collaborated closely with stakeholders to align the platform with business objectives, providing insurance solutions for educational and healthcare organizations",
