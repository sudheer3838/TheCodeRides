const aboutUsData = [
  {
    ...
    primarySkills: [
      ...
      { tech: 'Bootstrap', techDec: 'A popular front-end framework for building responsive, mobile-first web interfaces using pre-designed components.', selfRating: 85 },
      { tech: 'jQuery UI', techDec: 'A library of user interface widgets and interactions to simplify creating dynamic, interactive web applications.', selfRating: 80 },
      { tech: 'WCAG 2.0', techDec: 'Accessibility guidelines to ensure digital content is usable for people with disabilities.', selfRating: 88 },
      { tech: 'PSD to HTML', techDec: 'Converting design files from Photoshop (PSD) to functional, clean, and responsive HTML and CSS code.', selfRating: 90 },
      { tech: 'Responsive Design', techDec: 'An approach to web development that ensures layouts adapt to various screen sizes, providing an optimal user experience.', selfRating: 95 },
      { tech: 'Foundation UI', techDec: 'A front-end framework designed for creating accessible, responsive, and modern web interfaces.', selfRating: 80 },
      { tech: 'ReactStrap', techDec: 'A library of React components based on Bootstrap for building consistent and reusable UIs.', selfRating: 75 },
      { tech: 'Angular Material', techDec: 'A UI component library for Angular that follows Material Design principles for polished, accessible user interfaces.', selfRating: 75 },
      { tech: 'SASS/SCSS', techDec: 'CSS preprocessors that add features like variables, nesting, and mixins for maintainable and scalable styling.', selfRating: 85 },
      { tech: 'Tailwind CSS', techDec: 'A utility-first CSS framework that speeds up development with pre-defined, customizable classes.', selfRating: 90 },
      { tech: 'SEO Best Practices', techDec: 'Understanding search engine optimization (SEO) practices to ensure that HTML content is well-structured and optimized for search engines.', selfRating: 80 },
      { tech: 'W3C Standards', techDec: 'Adhering to World Wide Web Consortium (W3C) standards for web development to ensure compatibility and best practices in HTML.', selfRating: 90 },
      { tech: 'Forms & Validation', techDec: 'Implementing HTML forms and using built-in form validation to gather and process user input efficiently and securely.', selfRating: 85 },
      { tech: 'Web Performance Optimization', techDec: 'Optimizing HTML and assets for faster load times, such as lazy loading, image compression, and efficient resource management.', selfRating: 80 },
